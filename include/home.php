...
<div class="row">
    <div class="col-sm-4">
        <!-- <h2>Sản Phẩm</h2> -->
        <a data-toggle="tooltip" title="Thời trang nữ!" href="?pages=product"> <img src="images/banner-1.jpg" alt=""></a>
        <hr>
        <a href="#"> <img src="images/banner-4.jpg" alt=""></a>
    </div>
    <div class="col-sm-8">
        <a data-toggle="tooltip" title="Thời trang nam!" href="?pages=product"> <img src="images/banner-11.jpg" alt=""></a>
    </div>
</div>
    ...
    <div class="row padding">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
            <div class="card text-left">
                <img height="auto" width="350px" class="img_product" src="<?php echo $value['anh_sanpham'] ?>" alt="">
