...
WHERE donhang.phone ='$keyword_don_hang' ");
var_dump($don_hang);
?>
<div class="container-fluid">
    ...
    <form action="" method="GET">
        ...
        <div class="input-group mb-3">
            <input require type="text" class="form-control" placeholder="Nhập số điện thoại đặt hàng của bạn ..."
                name="keyword_don_hang">
            <div class="input-group-append">
                <button class="btn btn-secondary" type="submit"><img src="images/icon/search.png" style="width: 20px;"
                        alt=""></button>
            </div>
        </div>
    </form>
    ...
    <div class="row giohang ">
        ...
        <div class=" col-sm-3 col-md-3 col-lg-3"> Thông tin:
            <a href="?pages=chitiet_donhang&ma_donhang=<?= $value['ma_donhang'] ?>"
