<?php
    ...
    if(isset($_POST['email'])) {
        ...
        $check = mysqli_query($conn,"SELECT * FROM admin WHERE email ='$email'  and pass='$password'");
        ...
        if(mysqli_num_rows($check) == 1) {
            ...
            ?>
            <script>alert("Bạn sai mật khẩu hoặc tên tài khoản vui lòng kiểm tra lại.");</script>
            <?php
        }
