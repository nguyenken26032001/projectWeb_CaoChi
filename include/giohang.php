...
if (isset($_POST['submit'])) {
  ...
  if ($diachi) {
    ...
    $dat_hang = mysqli_query($conn, "INSERT INTO donhang(ma_donhang,id_product,id_user,soluong,gia_sanpham,trang_thai,email,phone) VALUES
      ('$ma_donhang','$id_product','$id_user','$soluong','$gia_sanpham','$trangthai','$email','$phone')");
...
<?php
    ...
    $themvaogio = mysqli_query($conn, "INSERT INTO giohang(id_product,id_user,ten_sanpham,anh_sanpham,soluong,gia_sanpham)
    VALUES('$id_product','$id_user','$ten_sanpham','$anh_sanpham','$quantity','$gia_sanpham' ) ");
    if ($themvaogio) {
...
if (isset($_POST['capnhat'])) {
  ...
  for ($i = 0; $i < count($_POST['id_product']); $i++) {
    ...
    $capnhat = mysqli_query($conn, "UPDATE giohang SET soluong ='$quantity' WHERE id_product ='$id_product' AND id_user = '$id_user'");
        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    ...
                    <span class="text-muted"><?php echo number_format($giasanpham = $soluong * $gia_sanpham) ?>
                        VND</span>
                </li>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" novalidate="" method="POST" action="">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="Name" placeholder="Tên người của bạn"
                ...
                <div class="mb-3">
                    <label for="email">Email <span class="text-muted" _istranslated="1">(Lưu ý ghi nhớ email của bạn để
                            kiểm tra đơn hàng)</span></label>
        ...
        <div class="row giohang ">
            ...
            <div class="col-6 col-sm-2 col-md-2 col-lg-2">
              ...
              $sanpham = mysqli_fetch_assoc($product); ?>
                Số lượng: <input class=" quantity" type="number" value="<?php echo $value['soluong'] ?>"
            ...
            <div class="col-4 col-sm-1 col-md-1 col-lg-1">
                <a class="btn btn-outline-secondary"
                    href="?pages=chitietsanpham&sanpham=<?php echo $value['id_product'] ?>">Chi tiết</a>
            </div>
            <div class="col-4 col-sm-1 col-md-1 col-lg-1">
                <a class="btn btn-outline-secondary"
                    onclick="return confirm('Xóa sản phẩm: <?php echo $value['ten_sanpham'] ?> không ?');"
                    href="include/xoasanpham.php?id=<?php echo $value['id'] ?>">Xóa</a>
            </div>
