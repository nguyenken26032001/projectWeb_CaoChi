          ...
          <form class="needs-validation" novalidate="" method="POST" action="">
            ...
            <div class="d-block my-3">
              <div class="custom-control custom-radio">
                <input id="credit" name="thanhtoan" value="0" type="radio" class="custom-control-input" checked="" required="true">
        ...
        ?>
          ...
          <div class="row giohang ">
            ...
            <div class="col-6 col-sm-2 col-md-2 col-lg-2">
              ...
              Số lượng: <input class=" quantity" type="number" value="<?php echo $value['soluong'] ?>" name="quantity[]" min="1" max="<?php echo $sanpham['soluong'] ?>">
