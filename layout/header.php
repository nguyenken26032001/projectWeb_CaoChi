...
<head>
    ...
    <title>Shop bán hàng Cao Chí Nhân</title>
...
<body>
    ...
    <div class="jumbotron text-center" style="margin-bottom:0">
        <div class="row">
            <div class="col-sm-4">
                <a href="?pages=home" data-toggle="tooltip" title="về trang chủ!"> <img src="images/icon/Logo.png" alt=""></a>
            </div>
            <div class="col-sm-8">
            ...
            <ul class="navbar-nav ml-auto">
                <ul class="navbar-nav">
                    <?php if (isset($user['name'])) { ?>
                        <a href="?pages=users">
                            <li class="nav-item" style="color: white; font-size: 18px;"><?= $user['name']; ?>&nbsp;&nbsp;&nbsp; </li>
                        </a>
                        ...
                        <a href="include/logout.php" style="color: white; "> Đăng xuất&nbsp;<i class="fas fa-sign-out-alt"></i></a>
